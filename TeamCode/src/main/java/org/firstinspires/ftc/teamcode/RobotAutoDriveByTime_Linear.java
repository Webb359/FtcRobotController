...
public class RobotAutoDriveByTime_Linear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.driveTimed(0, 1, 0, 3000); // Adjust time to match 27 inches
        ...
        robot.driveTimed(0, 0, 1, 1000); // Adjust time to match a 90-degree turn

        // Step 4: Drive forward for 105 inches
        robot.driveTimed(0, 1, 0, 8000); // Adjust time to match 105 inches

        // Step 5: Turn left 90 degrees again
        robot.driveTimed(0, 0, 1, 1000);

        // Step 6: Drive forward for 15.5 inches
        robot.driveTimed(0, 1, 0, 1500); // Adjust time to match 15.5 inches
        ...
        robot.driveTimed(0, 0, -1, 2000); // Adjust time to match a 180-degree turn
